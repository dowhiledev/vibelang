...
symbol_t* symbol_add(symbol_scope_t* scope, const char* name, symbol_kind_t kind, 
                   ast_node_t* node, ast_node_t* type_node) {
...
static const char* symbol_kind_names[] = {
    "TYPE", "FUNCTION", "VAR", "PARAMETER", "CLASS"
};
